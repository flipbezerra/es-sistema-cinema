...
from aplicativo.models import MovieMaster, SetMovie
...
def registerPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            context = {'form': form}
            return render(request, 'aplicativo_usuario/register.html',context)
...
def loginPage(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            # return render(request, 'aplicativo_usuario/user_dashboard.html')
    ...
    return render(request, 'aplicativo_usuario/login.html')
...
class BookTickets(View):
    ...
    initial = {'key': 'value'}
    template_name = "aplicativo_usuario/bookticket.html"
...
class UserDashboard(generic.ListView):
    ...
    model_set = SetMovie
    template_name = "aplicativo_usuario/user_dashboard.html"
...
class BuyTicket(generic.ListView):
    template_name = "aplicativo_usuario/buyticket.html"
    model = SetMovie
...
class BookHistory(generic.ListView):
    ...
    template_name = "aplicativo_usuario/book_history.html"
...
class DownloadTicket(generic.ListView):
    ...
    template_name = "aplicativo_usuario/downloadticket.html"
...
class Ticket(generic.DetailView):
    ...
    template_name = "aplicativo_usuario/ticket.html"
"""